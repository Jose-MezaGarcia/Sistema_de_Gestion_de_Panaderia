...
/**
 * Controlador de la vista de Recibos en la aplicación Dulce Tentación.
 * Se encarga de manejar la lógica de la interfaz gráfica relacionada con
 * la gestión de recibos, incluyendo navegación entre ventanas y configuración inicial.
 *
...
public class RecibosController implements IController {
    ...
    /** Tabla que muestra los detalles de venta asociados a los recibos */
    @FXML
    ...
    /** Botón para agregar productos al recibo */
    @FXML
    private Button btnAgregar;

    /** Botón para guardar el recibo */
    @FXML

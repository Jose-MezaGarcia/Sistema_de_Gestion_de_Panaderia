...
/**
 * Controlador de la vista de Pedidos en la aplicación Dulce Tentación.
 * Se encarga de manejar la lógica de la interfaz gráfica relacionada con
 * la gestión de pedidos, incluyendo navegación entre ventanas y configuración inicial.
 *
...
public class PedidosController implements IController {
    ...
    /** Tabla que muestra los detalles de venta asociados a los pedidos */
    @FXML
    ...
    /** Columna para la cantidad pedida */
    @FXML
    private TableColumn<DetalleVenta, Integer> colCantidad;

    /** Columna para el subtotal del pedido */
    @FXML
    ...
    /** Campo de texto para mostrar el total del pedido */
    @FXML
    ...
    private void cambiarVentana(javafx.event.ActionEvent event, String rutaFXML, String titulo) {
        try {
            ...
            stage.show();
            // en caso de fallar se informa en la consola del IntelliJ IDEA
        } catch (Exception e) {
            e.printStackTrace();

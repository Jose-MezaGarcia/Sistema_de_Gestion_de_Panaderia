...
/**
 * Controlador de la vista de Reportes en la aplicación Dulce Tentación.
 * Se encarga de manejar la lógica de la interfaz gráfica relacionada con
 * la generación y visualización de reportes, incluyendo navegación entre ventanas
 * y configuración inicial de la vista.
 *
...
public class ReportesController implements IController {
    ...
    /** Tabla que muestra los detalles de venta asociados a los reportes */
    @FXML
    ...
    /** Botón para agregar productos al reporte */
    @FXML

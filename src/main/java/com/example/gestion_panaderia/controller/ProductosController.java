...
/**
 * Controlador de la vista de Productos en la aplicación Dulce Tentación.
 * Se encarga de manejar la lógica de la interfaz gráfica relacionada con
 * la gestión de productos, incluyendo navegación entre ventanas y configuración inicial.
 *
...
public class ProductosController implements IController {
    ...
    /** Tabla que muestra los detalles de venta asociados a los productos */
    @FXML
    ...
    /** Botón para guardar cambios en los productos */
    @FXML
